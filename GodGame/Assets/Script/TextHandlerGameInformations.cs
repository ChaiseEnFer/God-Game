...
public class NewBehaviourScript : MonoBehaviour
{
    ...
    private void UpdateText()
    {
        ...
        _textEntitiesNumber.text = GameManager.Instance.selectedCharacter.GetComponent<PeopleProperties>().EntityNumber;
        _textFoodQuantity.text = GameManager.Instance.selectedCharacter.GetComponent<PeopleProperties>().QuantityFood;
    }
}
